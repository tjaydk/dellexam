...
public class facturaDokumentationViewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        factura = view.fetchFactura(id_factura);
        

        HttpSession session = request.getSession();

        session.setAttribute("facturaViewer", factura);

        RequestDispatcher disp = request.getRequestDispatcher("facturaDokumentationView.jsp");
