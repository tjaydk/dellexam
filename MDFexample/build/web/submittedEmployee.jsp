...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p>Factura has been uploaded</p>
            <br/>
            <p>You will be redirected to dashboard within <span id="counter">20</span> seconds - or <a href="http://localhost:8080/MDFexample/loginServletEmployee">click here</a> to go to front page</p>
        </div>
